...
function EditNews() {
  ...
  const [announcementImage, setAnnouncemetImage] = useState(news.image);
  const [announcementTitle, setAnnouncemetTitle] = useState(news.title);
  const [announcementDetails, setAnnouncemetDetails] = useState(news.details);
